...
evidence:
  - kind: adr
    ref: docs/adr/0001-session-registration-status.md
---
# Registration Status

This subject has provenance in frozen ADR history ([0001-session-registration-status.md](../adr/0001-session-registration-status.md)) but no living
...
When a living decision is ratified for registration status,
