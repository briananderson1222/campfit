...
This subject has provenance in frozen ADR history ([0002-verified-camp-session-claim-sets.md](../adr/0002-verified-camp-session-claim-sets.md)) but no living
...
When a living decision is ratified for verified session claim set,
