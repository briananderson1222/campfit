...
const config = [
  ...
  },
  {
    ...
    files: [
      ...
      "app/api/admin/attestations/[attestationId]/route.ts",
      ...
      "app/api/admin/crawl/list/route.ts",
      "app/api/admin/crawl/onboard-url/route.ts",
      "app/api/admin/crawl/preview/route.ts",
      "app/api/admin/people/[personId]/route.ts",
      "app/api/admin/people/roles/[roleType]/[roleId]/route.ts",
      "app/api/admin/providers/[providerId]/crawl/route.ts",
      "app/api/admin/provider-proposals/[id]/approve/route.ts",
      "app/api/admin/provider-proposals/[id]/reject/route.ts",
      ...
      "app/api/camps/[slug]/report/route.ts",
